        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <center><b>Tidak Punya Akun?</b></center>
                    	<center><b><a class="btn btn-primary" href="{{ url('/register/member') }}">Buat Sebagai Member</a></b></center>
                    	<center><b>Atau</b></center>
                    	<center><b><a class="btn btn-primary" href="{{ url('/register/perusahaan') }}">Buat Sebagai Perusahaan</a></b></center>
